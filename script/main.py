...
robot_num = 2
robot_location = [[7,6], [0,0]] # The robot pose in map frame when calling task allocation 
robot_status   = [[1,1], [1,1]] # robot_status[i][j] is 1 means robot[i+1] can carry out task[j+1]
task1_location = [[3,3], [1,5], [7,9]] # Digital Recognize
task2_location = [[0,1], [0,5], [7,8]] # Temperature Detection
